...
public class Tarea2 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Valor de las Bebidas: $" + exp.getPrecioBebidas() + "\n");
        ...
        Comprador joaquinComprador = new Comprador(mon1, 1, exp);
        ...
        Comprador pabloComprador = new Comprador(mon2, 2, exp);
        ...
        Comprador lissetteComprador = new Comprador(mon3, 1, exp);
        ...
        Comprador EstebanComprador = new Comprador(mon4, 3, exp);
        System.out.println("Vuelto: $" + EstebanComprador.cuantoVuelto());
        System.out.println("Sabor: " + EstebanComprador.queBebiste() + "\n");

        // compra sin moneda y no realizada con exito, no puede comprar con moneda nula y Vuelto $0 su moneda nula
        // retorno excepcion PagoInsuficienteException
        Moneda mon5 = null;
        Comprador lukasComprador = new Comprador(mon5, 3, exp);
